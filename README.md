...
Step 4: Enter number of plugs to be used in plugboard (0-13)
Step 5: If plugs were chosen, user will be prompted to choose sockets for each plug, else step will be skipped
Step 6: Enter text for encryption

Printed numbers will show each step of the rotors throughout encryption process
Final printout shows encrypted/decrypted text
